	 ...
	 ?>
      ...
      <div class="card mb-3">
        <div class="card-header">
          <i class="fa fa-table"></i> Candidates waiting for processing  </div>
        <div class="card-body">
              ...
              <tbody>
             	 <?php
					...
					while($result=mysql_fetch_assoc($query_run)){
						...
						$query_candidate_details="select * from candidate_register where candidate_id='$candidate_id' AND application_status='pending'";
				...
				?>
                            <tr>
                              ...
                              href="process_candidate.php?candidate_id=<?php echo $candidate_id;?>&&ans_id=<?php echo $answer_sheet_id;?>" >Process</a></td>
                            </tr>
               	<?php
						}
					}
