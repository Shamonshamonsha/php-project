            ...
            <div class="card-body">
                <div class="card mb-4">
                    <div class="card-body">
                      ...
                      <div <?php if($result_answers['user_answer_'.$answer_falg]==$result['personality_marker_1']){?> style="color:#0C9; font-weight:600;" <?php }?>>  
                      ...
                      <hr>
                      <div <?php if($result_answers['user_answer_'.$answer_falg]==$result['personality_marker_2']){?> style="color:#0C9; font-weight:600;" <?php }?>>  
                      ...
                      <hr>
                      <div <?php if($result_answers['user_answer_'.$answer_falg]==$result['personality_marker_3']){?> style="color:#0C9; font-weight:600;" <?php }?>>  
                      ...
                      <hr>
                      <div <?php if($result_answers['user_answer_'.$answer_falg]==$result['personality_marker_4']){?> style="color:#0C9; font-weight:600;" <?php }?>>  
