  ...
  <div class="content-wrapper">
    <div class="container-fluid">
        <div class="card card-register mx-auto mt-5">
          ...
          <div class="card-body">
            <form action="update_profile.php?ok" method="post">
              <div class="form-group">
                <label for="exampleInputName">Name</label>
                <input class="form-control" id="exampleInputName" name="name" type="text" aria-describedby="nameHelp" placeholder="Name" required>
              </div>
              <div class="form-group">
                <div class="form-row">
                  <div class="col-md-6">
            ...
            <?php
                if(isset($_POST['name'])&&isset($_POST['contact'])&&isset($_POST['email'])){
                    ...
                    $candidate_address=$_POST['address'];
                    $candidate_contact=$_POST['contact'];
                    $candidate_email=$_POST['email'];
                    
                    //adding candidate details to database
                    $query_reg="INSERT INTO `candidate_register`(`candidate_id`, `candidate_name`, `candidate_address`, `candidate_contact`, `candidate_email`, `candidate_cv`,`application_status`) VALUES ('$candidate_id','$candidate_name','$candidate_address','$candidate_email','$candidate_contact','null','pending')"; 
                    $query_reg_run=mysql_query($query_reg);
                    
                    if($query_reg_run){
                        ?>
                        <script>
                            document.location.href = 'candidate_home.php?flag=profile_updated';
                        </script>
                        <?php
                    }else{
