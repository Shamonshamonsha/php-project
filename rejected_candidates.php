	 ...
	 ?>
      ...
      <div class="card mb-3">
        <div class="card-header">
          <i class="fa fa-table"></i> Rejected Applications
        <div class="card-body">
              ...
              <tbody>
             	 <?php
					...
					while($result=mysql_fetch_assoc($query_run)){
						...
						$query_candidate_details="select * from candidate_register where candidate_id='$candidate_id' AND application_status='rejected'";
